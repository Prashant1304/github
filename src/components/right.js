          ...
          {/* search detail */}
             <div id="filter_div">
                ...
                <div style={{float:"left"}}>
                    {/* type detail */}
              <details id="type_options" ref={this.container}>
                <summary className = "summary_btn" aria-haspopup="menu" role="button" onClick={this.handleButtonClick}>
            ...
            {/* Language details */}
            <div>
              <details id="language_options" ref={this.container}>
                <summary className = "summary_btn" aria-haspopup="menu" role="button" onClick={this.handleButtonClick} >
                  <font style={{ fontSize: "14px", fontWeight: "100" }}>
                    Language:
                  </font>
